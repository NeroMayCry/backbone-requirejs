...
*/
	 ...
	 * IE 6-9 only.
	 * @private
	 * @regoods {HTMLElement} a stylesheet element to act as a collector sheet
	 */
	...
	function isLinkReady (link) {
		...
		try {
			...
			if (sheet) {
				...
				// will regoods null when an XD sheet is loaded
	 ...
	 * If we regoods before readyState == 'complete', Chrome may not have
